...
const en = {
  ...
  ttsNoSelection: 'Select Chinese or English text first',
  ttsNoContent: 'No Chinese or English content found to read.',
  ttsUnsupportedLanguage:
    'The selected read-aloud language does not match the original or translation (only Chinese and English are supported).',
  ...
  ttsSpeechLang: 'Read aloud language',
  ttsSpeechLangAuto: 'Auto',
  ttsSpeechLangEn: 'English',
  ttsSpeechLangZh: 'Chinese',
  ttsSpeechLangHint:
    'Auto uses the original text. Choosing English or Chinese prefers that language in the original, otherwise the translation; if neither matches, reading is not supported.',
  ttsNowPlaying: 'Now playing',
  ttsSubtitleLangEn: 'EN',
  ttsSubtitleLangZh: 'ZH',
  ttsDefaultVoice: 'Default voice',
  ttsSystemDefault: 'System default voice',
  ...
  ttsEndMode: 'When finished',
  ttsEndModeLoop: 'Loop playback',
  ttsEndModeStop: 'Stop and keep the player',
  ttsEndModeExit: 'Close the player',
  ttsEndModeHint:
    'Loop restarts from the beginning. Stop keeps the player so you can resume. Close hides the player when done.',
  ...
  ttsNoVoices:
    'No Chinese or English voices found. Install a voice pack in Windows Settings → Time & language → Speech, then reload this page.',
...
const zhCN: Record<MessageKey, string> = {
  ...
  ttsNoSelection: '请先选中中文或英文内容',
  ttsNoContent: '未找到可朗读的中文或英文内容。',
  ttsUnsupportedLanguage: '当前朗读语言与原文/译文均不匹配（仅支持中文和英文）。',
  ...
  ttsSettings: '朗读设置',
  ttsSpeechLang: '朗读语言',
  ttsSpeechLangAuto: '自动',
  ttsSpeechLangEn: '英文',
  ttsSpeechLangZh: '中文',
  ttsSpeechLangHint:
    '自动时优先朗读原文。指定英文/中文时：先匹配原文，再匹配译文；都不匹配则无法朗读。',
  ttsNowPlaying: '正在播放',
  ttsSubtitleLangEn: '英文',
  ttsSubtitleLangZh: '中文',
  ttsDefaultVoice: '默认语音',
  ttsSystemDefault: '系统默认语音',
  ttsSplitParagraphs: '整页朗读时按段落拆分（推荐）',
  ttsHighlightCurrent: '朗读时高亮当前段落',
  ttsEndMode: '播放结束后',
  ttsEndModeLoop: '循环播放',
  ttsEndModeStop: '停止并保留播放器',
  ttsEndModeExit: '自动退出播放器',
  ttsEndModeHint: '循环：播完从头再播。停止：保留播放器，可点继续重播。退出：播完关闭播放器。',
  ...
  ttsNoVoices:
    '未检测到中文或英文语音。请到 Windows「设置 → 时间和语言 → 语音」安装语音包，然后刷新本页。',
